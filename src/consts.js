...
//export const meterCommands = ['GSA', 'GSI', 'GSO', 'GSS', 'GSX', 'GSM', 'GSN'] //metering commands issued each meterInterval
export const meterCommands = ['GS'] //metering commands issued each meterInterval
...
export const cmdOnPollInterval = ['SNA', 'SNC'] //queries to be made each poll interval
